			...
			<div id="container" class="container">
				...
				<div class="inner">
					<div class="diningContainer drDining_st02">
						<div class="chkValue">
							<span>엘리시안 호텔<!-- 그랜드 조선 부산 --></span><span id="diningName">
								<!-- The Ninth Gate -->
							</span>
						</div>
						<div class="diningSelectCont calCont">
							...
							<div class="rCont">
								...
								<div class="intArea selectWrap" style="width: 385px">
									<select id="personCountSelect" data-height="150px"
										data-direction="down" aria-required="true"
										onchange="fncSelectTime()">
								...
								<div class="allTimeSwitch">
									<fieldset>
										...
										<!-- 모든 시간 보기 --> <input role="switch" type="checkbox"
											id="seatsSwitch" onchange="ShowRoomHallTimes();">
										</label>
									</fieldset>
								</div>
